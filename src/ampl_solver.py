...
def solve_optimal(dat_file_path, mod_file_path, solver="gurobi"):
    """
    ...
    try:
        ...
        # opciones del solver (0% de MIP gap, para asegurar el real valor óptimo)
        ampl.setOption(f'{solver}_options', f'mipgap=0')
